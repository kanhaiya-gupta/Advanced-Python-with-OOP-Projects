...
# Script to activate the app1_env Conda environment for App-1-Photo-Searcher
...
# Activate the app1_env environment
echo "Activating app1_env environment..."
conda activate app1_env

# Verify activation
if [ "$CONDA_DEFAULT_ENV" != "app1_env" ]; then
    echo "Error: Failed to activate app1_env environment"
    echo "Current environment: $CONDA_DEFAULT_ENV"
    exit 1
else
    echo "Successfully activated app1_env environment"
fi

...
# Script to activate the app5_env Conda environment for App-5-Flatmates-Bill-Web-App
...
# Activate the app5_env environment
echo "Activating app5_env environment..."
conda activate app5_env

# Verify activation
if [ "$CONDA_DEFAULT_ENV" != "app5_env" ]; then
    echo "Error: Failed to activate app5_env environment"
    echo "Current environment: $CONDA_DEFAULT_ENV"
    exit 1
else
    echo "Successfully activated app5_env environment"
fi

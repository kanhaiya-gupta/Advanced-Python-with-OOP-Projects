...
# Script to activate the app7_env Conda environment for App-7-Automated-Emails
...
# Activate the app7_env environment
echo "Activating app7_env environment..."
conda activate app7_env

# Verify activation
if [ "$CONDA_DEFAULT_ENV" != "app7_env" ]; then
    echo "Error: Failed to activate app7_env environment"
    echo "Current environment: $CONDA_DEFAULT_ENV"
    exit 1
else
    echo "Successfully activated app7_env environment"
fi

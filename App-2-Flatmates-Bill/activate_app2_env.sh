...
# Script to activate the app2_env Conda environment for App-2-Flatmates-Bill
...
# Activate the app2_env environment
echo "Activating app2_env environment..."
conda activate app2_env

# Verify activation
if [ "$CONDA_DEFAULT_ENV" != "app2_env" ]; then
    echo "Error: Failed to activate app2_env environment"
    echo "Current environment: $CONDA_DEFAULT_ENV"
    exit 1
else
    echo "Successfully activated app2_env environment"
fi

...
# Script to activate the app8_env Conda environment for App-8-Instant-Dictionary-Webapp
...
# Activate the app8_env environment
echo "Activating app8_env environment..."
conda activate app8_env

# Verify activation
if [ "$CONDA_DEFAULT_ENV" != "app8_env" ]; then
    echo "Error: Failed to activate app8_env environment"
    echo "Current environment: $CONDA_DEFAULT_ENV"
    exit 1
else
    echo "Successfully activated app8_env environment"
fi

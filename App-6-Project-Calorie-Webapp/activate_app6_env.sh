...
# Script to activate the app6_env Conda environment for App-6-Project-Calorie-Webapp
...
# Activate the app6_env environment
echo "Activating app6_env environment..."
conda activate app6_env

# Verify activation
if [ "$CONDA_DEFAULT_ENV" != "app6_env" ]; then
    echo "Error: Failed to activate app6_env environment"
    echo "Current environment: $CONDA_DEFAULT_ENV"
    exit 1
else
    echo "Successfully activated app6_env environment"
fi

...
# Script to activate the app4_env Conda environment for App-4-Webcam-Photo-Sharer
...
# Activate the app4_env environment
echo "Activating app4_env environment..."
conda activate app4_env

# Verify activation
if [ "$CONDA_DEFAULT_ENV" != "app4_env" ]; then
    echo "Error: Failed to activate app4_env environment"
    echo "Current environment: $CONDA_DEFAULT_ENV"
    exit 1
else
    echo "Successfully activated app4_env environment"
fi

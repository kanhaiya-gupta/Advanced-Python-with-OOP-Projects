...
# Script to activate the app3_env Conda environment for App-3-Project-Math-Painting
...
# Activate the app3_env environment
echo "Activating app3_env environment..."
conda activate app3_env

# Verify activation
if [ "$CONDA_DEFAULT_ENV" != "app3_env" ]; then
    echo "Error: Failed to activate app3_env environment"
    echo "Current environment: $CONDA_DEFAULT_ENV"
    exit 1
else
    echo "Successfully activated app3_env environment"
fi

...
# Script to activate the app10_env Conda environment for App-10-Cinema-Ticket-Booking
...
# Activate the app10_env environment
echo "Activating app10_env environment..."
conda activate app10_env

# Verify activation
if [ "$CONDA_DEFAULT_ENV" != "app10_env" ]; then
    echo "Error: Failed to activate app10_env environment"
    echo "Current environment: $CONDA_DEFAULT_ENV"
    exit 1
else
    echo "Successfully activated app10_env environment"
fi
